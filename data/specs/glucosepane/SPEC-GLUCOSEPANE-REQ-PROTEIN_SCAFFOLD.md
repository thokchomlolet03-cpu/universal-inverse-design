# Layer 3 De Novo Design Specification: SPEC-GLUCOSEPANE-REQ-PROTEIN_SCAFFOLD

**Target Domain:** Glucosepane  
**Addressed Epistemic Gap:** `req:protein_scaffold` (HIGH Priority)  
**Objective:** A known protein scaffold (bacterial, fungal, or de novo designed) whose active site can be modified to accommodate glucosepane binding
...
| **3D Conformer File (.sdf)** | [`/Users/lolet/Universal Inverse Design/data/specs/glucosepane/SPEC-GLUCOSEPANE-REQ-PROTEIN_SCAFFOLD_substrate_3d.sdf`](file:///Users/lolet/Universal Inverse Design/data/specs/glucosepane/SPEC-GLUCOSEPANE-REQ-PROTEIN_SCAFFOLD_substrate_3d.sdf) |
...
```json
{
  ...
  "input_ligand_sdf": "/Users/lolet/Universal Inverse Design/data/specs/glucosepane/SPEC-GLUCOSEPANE-REQ-PROTEIN_SCAFFOLD_substrate_3d.sdf",
