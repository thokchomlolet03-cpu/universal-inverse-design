# Layer 3 De Novo Design Specification: SPEC-GLUCOSEPANE-REQ-CRYSTAL_STRUCTURE

**Target Domain:** Glucosepane  
**Addressed Epistemic Gap:** `req:crystal_structure` (HIGH Priority)  
**Objective:** Experimentally resolved 3D structure of glucosepane crosslinked within native collagen fibers (X-ray crystallography or cryo-EM)
...
| **3D Conformer File (.sdf)** | [`/Users/lolet/Universal Inverse Design/data/specs/glucosepane/SPEC-GLUCOSEPANE-REQ-CRYSTAL_STRUCTURE_substrate_3d.sdf`](file:///Users/lolet/Universal Inverse Design/data/specs/glucosepane/SPEC-GLUCOSEPANE-REQ-CRYSTAL_STRUCTURE_substrate_3d.sdf) |
...
```json
{
  ...
  "input_ligand_sdf": "/Users/lolet/Universal Inverse Design/data/specs/glucosepane/SPEC-GLUCOSEPANE-REQ-CRYSTAL_STRUCTURE_substrate_3d.sdf",
